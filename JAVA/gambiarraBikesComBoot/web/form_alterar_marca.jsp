<%-- 
    Document   : form_alterar_marca
    Created on : 08/10/2018, 23:57:15
    Author     : Ygor
--%>
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
         ...
         <h2>Alterando Marca</h2>
           
            
            
           
   
<form method="post" action="alterar_marca.do">
   <table class="table table-bordered"  width="100%" cellspacing="0">
        <tr>
            <h5>ID:<%=m.getId() %></h5><br/>
            <input type="hidden" value="<%=m.getId() %>" name="id"/>
            <td><h5>Nome:</h5>
                <input type="text" value="<%=m.getNome() %>" name="nome" size="60" required/><br/>
        </tr>
