<%-- 
    ...
    Created on : 09/10/2018, 23:38:13
    Author     : Ygor
--%>
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
         ...
         <h2>Novo Serviço</h2>
 <form method="post" action="inserir_servico.do">
   
   <table class="table table-bordered"  width="100%" cellspacing="0">
        <tr>
            <td><h5>Entrega:</h5>
                <input type="text" name="entrega" size="30" required/><br/></td> 
		...
		<select name="tipo" >
          ...
          <tr> 
              <td><h5>Descricao:</h5>
                  <input type="text" name="descricao" size="30" required/><br/></td> 
              <td><h5>Preço:</h5>
                  <input type="text" name="preco" size="30" required/><br/></td>
          </tr>  
