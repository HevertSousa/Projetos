<%-- 
    ...
    Created on : 14/08/2018, 21:36:49
...
<html lang="pt-br">
 ...
 <form action="inserir_menu.do" method="post">        
   <table class="table table-bordered"  width="100%" cellspacing="0">
        <tr>
            <td><h5>Título:</h5>
                <input type="text" name="titulo" size="50" required/><br/></td> 
            <td><h5>Link:</h5>
                <input type="text" name="link" size="50" required/><br/></td> 
        </tr>
        
          <tr> 
              <td><h5>Ícone:</h5>
                  <input type="text" name="icone" size="50"/><br/></td> 
