<%-- 
    ...
    Created on : 09/10/2018, 20:27:58
    Author     : Ygor
--%>
...
<form action="inserir_cliente.do" method="post">
   <table class="table table-bordered"  width="100%" cellspacing="0">
        <tr>
           ...
           <td><h5>Nome:</h5>
               <input type="text" name="nome" size="50" required/></td> 
           <td><h5>Telefone:</h5>
               <input type="text" name="telefone" size="50" required/></td> 
        </tr>
        
          <tr> 
             <td>
                 <h5>Endereço:</h5>
                 <input type="text" name="endereco" size="50" required/></td> 
             <td><h5>CPF:</h5>
                 <input type="text" name="cpf" size="50" required/></td>
          </tr>  
     </table>
